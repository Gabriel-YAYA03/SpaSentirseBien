document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!token) {
        showToastError("No tienes permiso para acceder a esta página.");
    ...
    try {
        ...
        showToastError("Error de autenticación: " + error.message);
        window.location.href = "login.html";
        return;
    }
    ...
    document.getElementById("edit-service").addEventListener("click", async () => {
        ...
        if (!serviceId || isNaN(serviceId)) {
            showToastError("Debe ingresar un ID válido");
            return;
        }
    ...
    document.getElementById("delete-service").addEventListener("click", async () => {
        ...
        try {
            ...
            showToastError("Servicio eliminado exitosamente");
